...
public class Rune : MonoBehaviour,IPoolingObject
{
    ...
    public void CheckMatches(SwapType swapType = SwapType.None)
    {
        ...
        GameManager.Instance.Match.MatchBoard.OnRuneChangePostionAction(Tuple.Create(Row, Col), swapType);
    }
    ...
    {
        IsProtected = false;
        GameObject destroyEffect = GameManager.Instance.Match.MatchBoard.RuneObjectPoolManager.GetProtectDestroyEffectObject();
